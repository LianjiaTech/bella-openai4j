...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = FunctionShellTool.class, name = "shell"),
        @JsonSubTypes.Type(value = MCPTool.class, name = "mcp"),
        @JsonSubTypes.Type(value = CustomTool.class, name = "custom"),
        @JsonSubTypes.Type(value = NamespaceTool.class, name = "namespace"),
        @JsonSubTypes.Type(value = ToolSearchTool.class, name = "tool_search"),
        @JsonSubTypes.Type(value = ApplyPatchTool.class, name = "apply_patch")
})
